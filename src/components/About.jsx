...
const About = () => {
  return (
    <>
      ...
      >
        Développeur passionné, je crée des applications web fluides et modernes avec React, Node.js, <span className='text-2xl text-cyan-600 font-medium'>Laravel</span> et Three.js. Mon objectif : des expériences rapides, efficaces et agréables pour tous les utilisateurs, même sur mobile.
      </motion.p>
