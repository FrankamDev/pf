            ...
            <div className="flex items-start gap-5 justify-center lg:justify-start">
              ...
              <div className="space-y-6 md:space-y-8    ">
                ...
                <p className={`${styles.heroSubText} mt-4 text-gray-200 max-w-3xl leading-relaxed`}>
                  Je crée des sites et applications web modernes pour les entreprises : des interfaces simples à utiliser, rapides et agréables, qui permettent de présenter leurs services, vendre en ligne, attirer plus de clients et automatiser certaines tâches du quotidien, tout en améliorant leur visibilité et leur image professionnelle sur internet, grâce à des outils technologiques comme Next.Js, Laravel et Photoshop.
                </p>

                <p className="text-lg md:text-xl text-gray-400 font-light">
                  React • Next.js • Three.js • TypeScript • TailwindCSS • UI/UX • Laravel & Node.js
                </p>
              </div>
            </div>
